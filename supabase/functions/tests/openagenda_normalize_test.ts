...
Deno.test('normalizeOpenAgendaImage accepts img.openagenda.com host', () => {
  ...
  if (normalized?.remote_url !== 'https://img.openagenda.com/main/event.full.image.jpg') {
...
Deno.test('normalizeOpenAgendaEvent maps fixture shape', async () => {
  ...
  if (normalized.place.image?.remote_url !== 'https://cdn.openagenda.com/main/place.full.jpg') {
